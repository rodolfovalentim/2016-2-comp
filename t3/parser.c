...
{
       0,    65,    65,    68,    69,    72,    75,    78,    81,    82,
      85,    86,    89,    90,    93,    94,    97,    98,   101,   102,
     105,   106,   109,   110,   113,   114,   117,   118,   119,   120,
     121,   124,   127,   128,   130,   133,   134,   137,   140,   143,
     144,   147,   148,   149,   152,   155,   158,   161,   164,   165,
...
#line 69 "parser.y" /* yacc.c:1646  */
    { (yyval) = new_subtree(FUNC_DECL_LIST_NODE, 1, (yyvsp[0])); }
#line 1582 "parser.c" /* yacc.c:1646  */
    break;

  case 5:
#line 72 "parser.y" /* yacc.c:1646  */
    { (yyval) = new_subtree(FUNC_DECL_NODE, 2, (yyvsp[-1]), (yyvsp[0]));  scope++;}
#line 1588 "parser.c" /* yacc.c:1646  */
    break;

  case 6:
#line 75 "parser.y" /* yacc.c:1646  */
    { (yyval) = new_subtree(FUNC_HEADER_NODE, 3, (yyvsp[-4]), (yyvsp[-3]), (yyvsp[-1])); int index = get_index((yyvsp[-3])); int params_size = get_children_size((yyvsp[-1])); index = decl_function (index, params_size, yylineno); set_type((yyvsp[-3]), "id"); set_index((yyvsp[-3]), index);}
